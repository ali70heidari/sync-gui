...
export default function RemotesView({ config, onBack, onRefresh, activeTerminalRemote, onOpenTerminal }) {
  ...
  function openEdit(r) {
    setEditing({
      authMethod: r.privateKeyPath ? "key" : (r.authMethod || "password"),
      ...r,
    });
    setShowForm(true);
  }
              ...
              <>
                ...
                <label>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEditing({ ...editing, authMethod: e.target.value })
                    }
                  >
                  ...
                  <>
                    <label>
                      ...
                      <input
                        ...
                        placeholder="/home/user/.ssh/id_rsa or C:\Users\name\.ssh\id_rsa"
                      />
                    </label>
                    <label>
                      Passphrase (optional)
                      <div className="password-wrap">
                        <input
                          ...
                          placeholder="Key passphrase if protected"
                        />
                        <button
                          className="eye-btn"
                          type="button"
