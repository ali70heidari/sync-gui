...
function toMsysPath(value) {
  ...
  if (rawMatch) return `${process.env.SYNC_GUI_DRIVE_PREFIX || ''}/${rawMatch[1].toLowerCase()}/${rawMatch[2]}`;
  return raw;
}
...
assert.equal(
  toMsysPath('C:\\Users\\hamid\\Documents\\Work Projects\\kasb\\backend\\admin'),
  '/cygdrive/c/Users/hamid/Documents/Work Projects/kasb/backend/admin'
);
